...
If this does not work, try the following rhythm:
Turn off longer than 5 seconds, then on-off-on-off-on with approximately 2 or 3 seconds in each state. After that the bulb is lighting up differently
